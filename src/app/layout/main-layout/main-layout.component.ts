...
@Component({
  ...
  template: `
    <div class="dashboard-wrapper" [dir]="isArabic ? 'rtl' : 'ltr'">
      ...
      <!-- 📋 القائمة الجانبية البيضاء (Sidebar) -->
      <aside class="sidebar-container">
        ...
        <nav class="sidebar-nav-links">
          ...
          <button class="menu-link"><span class="icon">💼</span> Portfolios</button>
          <button class="menu-link"><span class="icon">📦</span> Programs</button>
          <button class="menu-link"><span class="icon">📁</span> Projects</button>
          <button class="menu-link"><span class="icon">🔄</span> Change Requests</button>
          <button class="menu-link"><span class="icon">📅</span> Plans</button>
          <button class="menu-link"><span class="icon">👥</span> Users</button>
          <button class="menu-link"><span class="icon">⚙️</span> Setting</button>
        </nav>
      </aside>

      <!-- 🖥️ منطقة المحتوى الرئيسي (Main Content) -->
      <div class="stage-canvas">
        
        <!-- الشريط العلوي (Top Nav Bar) -->
          ...
          <div class="user-meta-actions">
            ...
            <div class="profile-card-badge">
              ...
              <div class="profile-text-labels">
                ...
                <span class="account-email">PMO Email</span>
              </div>
